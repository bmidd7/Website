...
function renderIdealGasEquation(colors) {
    ...
    if (pressure[0] === null) {
        ...
        renderSolvedResult("P", `\\frac{nRT}{V} = \\frac{(${formatNumber(amount[0])})(0.0821)(${formatNumber(temperature[0])})}{${formatNumber(volume[0])}}`, result, "Atmosphere");
        return true;
    }
    if (volume[0] === null) {
        ...
        renderSolvedResult("V", `\\frac{nRT}{P} = \\frac{(${formatNumber(amount[0])})(0.0821)(${formatNumber(temperature[0])})}{${formatNumber(pressure[0])}}`, result, "Liters");
        return true;
    }
    if (amount[0] === null) {
        ...
        renderSolvedResult("n", `\\frac{PV}{RT} = \\frac{(${formatNumber(pressure[0])})(${formatNumber(volume[0])})}{(0.0821)(${formatNumber(temperature[0])})}`, result, "Moles");
        return true;
    }
    ...
    renderSolvedResult("T", `\\frac{PV}{nR} = \\frac{(${formatNumber(pressure[0])})(${formatNumber(volume[0])})}{(${formatNumber(amount[0])})(0.0821)}`, result, "Kelvin");
    return true;
}
function renderTwoStateLaw(colors) {
    const { GBV, GBP, GBT, GBN, GAV, GAP, GAT, GAN } = getGasInputs();
    ...
    switch (code) {
        case "1b00": {
            ...
            renderSolvedResult("V_2", `\\frac{P_1V_1}{P_2} = \\frac{(${formatNumber(beforePressure[0])})(${formatNumber(beforeVolume[0])})}{${formatNumber(afterPressure[0])}}`, result, "Liters");
            return true;
        }
        case "1a00": {
            ...
            renderSolvedResult("V_1", `\\frac{P_2V_2}{P_1} = \\frac{(${formatNumber(afterPressure[0])})(${formatNumber(afterVolume[0])})}{${formatNumber(beforePressure[0])}}`, result, "Liters");
            return true;
        }
        case "b100": {
            ...
            renderSolvedResult("P_2", `\\frac{P_1V_1}{V_2} = \\frac{(${formatNumber(beforePressure[0])})(${formatNumber(beforeVolume[0])})}{${formatNumber(afterVolume[0])}}`, result, "Atmosphere");
            return true;
        }
        case "a100": {
            ...
            renderSolvedResult("P_1", `\\frac{P_2V_2}{V_1} = \\frac{(${formatNumber(afterPressure[0])})(${formatNumber(afterVolume[0])})}{${formatNumber(beforeVolume[0])}}`, result, "Atmosphere");
            return true;
        }
        case "0b01": {
            ...
            renderSolvedResult("V_2", `\\frac{V_1T_2}{T_1} = \\frac{(${formatNumber(beforeVolume[0])})(${formatNumber(afterTemp[0])})}{${formatNumber(beforeTemp[0])}}`, result, "Liters");
            return true;
        }
        case "0a01": {
            ...
            renderSolvedResult("V_1", `\\frac{V_2T_1}{T_2} = \\frac{(${formatNumber(afterVolume[0])})(${formatNumber(beforeTemp[0])})}{${formatNumber(afterTemp[0])}}`, result, "Liters");
            return true;
        }
        case "010b": {
            ...
            renderSolvedResult("T_2", `\\frac{T_1V_2}{V_1} = \\frac{(${formatNumber(beforeTemp[0])})(${formatNumber(afterVolume[0])})}{${formatNumber(beforeVolume[0])}}`, result, "Kelvin");
            return true;
        }
        case "010a": {
            ...
            renderSolvedResult("T_1", `\\frac{T_2V_1}{V_2} = \\frac{(${formatNumber(afterTemp[0])})(${formatNumber(beforeVolume[0])})}{${formatNumber(afterVolume[0])}}`, result, "Kelvin");
            return true;
        }
        case "100b": {
            ...
            renderSolvedResult("T_2", `\\frac{T_1P_2}{P_1} = \\frac{(${formatNumber(beforeTemp[0])})(${formatNumber(afterPressure[0])})}{${formatNumber(beforePressure[0])}}`, result, "Kelvin");
            return true;
        }
        case "100a": {
            ...
            renderSolvedResult("T_1", `\\frac{T_2P_1}{P_2} = \\frac{(${formatNumber(afterTemp[0])})(${formatNumber(beforePressure[0])})}{${formatNumber(afterPressure[0])}}`, result, "Kelvin");
            return true;
        }
        case "b001": {
            ...
            renderSolvedResult("P_2", `\\frac{P_1T_2}{T_1} = \\frac{(${formatNumber(beforePressure[0])})(${formatNumber(afterTemp[0])})}{${formatNumber(beforeTemp[0])}}`, result, "Atmosphere");
            return true;
        }
        case "a001": {
            ...
            renderSolvedResult("P_1", `\\frac{P_2T_1}{T_2} = \\frac{(${formatNumber(afterPressure[0])})(${formatNumber(beforeTemp[0])})}{${formatNumber(afterTemp[0])}}`, result, "Atmosphere");
            return true;
        }
        case "01b0": {
            ...
            renderSolvedResult("n_2", `\\frac{n_1V_2}{V_1} = \\frac{(${formatNumber(GBN[0])})(${formatNumber(afterVolume[0])})}{${formatNumber(beforeVolume[0])}}`, result, "Moles");
            return true;
        }
        case "01a0": {
            ...
            renderSolvedResult("n_1", `\\frac{n_2V_1}{V_2} = \\frac{(${formatNumber(GAN[0])})(${formatNumber(beforeVolume[0])})}{${formatNumber(afterVolume[0])}}`, result, "Moles");
            return true;
        }
        case "0b10": {
            ...
            renderSolvedResult("V_2", `\\frac{V_1n_2}{n_1} = \\frac{(${formatNumber(beforeVolume[0])})(${formatNumber(GAN[0])})}{${formatNumber(GBN[0])}}`, result, "Liters");
            return true;
        }
        case "0a10": {
            ...
            renderSolvedResult("V_1", `\\frac{V_2n_1}{n_2} = \\frac{(${formatNumber(afterVolume[0])})(${formatNumber(GBN[0])})}{${formatNumber(GAN[0])}}`, result, "Liters");
            return true;
        }
        default:
            return false;
