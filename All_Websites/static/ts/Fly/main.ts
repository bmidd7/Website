...
const elements = {
  duration: document.getElementById('duration-input') as HTMLInputElement,
  fps: document.getElementById('fps-input') as HTMLInputElement,
  quality: document.getElementById('quality-select') as HTMLSelectElement,
  world: document.getElementById('world-select') as HTMLSelectElement,
  behavior: document.getElementById('behavior-select') as HTMLSelectElement,
  seed: document.getElementById('seed-input') as HTMLInputElement,
  arenaSize: document.getElementById('arena-size-input') as HTMLInputElement,
  submit: document.getElementById('submit-params') as HTMLButtonElement,
  status: document.getElementById('simulation-status') as HTMLParagraphElement,
  summary: document.getElementById('simulation-summary') as HTMLPreElement,
  canvas: document.getElementById('canvasDiv') as HTMLCanvasElement,
  video: document.getElementById('simulationVideo') as HTMLVideoElement,
  ...
  taskStatus: document.getElementById('task-manager-status') as HTMLParagraphElement,
  taskList: document.getElementById('task-manager-list') as HTMLOListElement,
  progressBar: document.getElementById('task-progress-bar') as HTMLDivElement,
  progressLabel: document.getElementById('task-progress-label') as HTMLDivElement,
};

const canvas: HTMLCanvasElement = elements.canvas;
const video: HTMLVideoElement = elements.video;
//
//MAY BE NULL
