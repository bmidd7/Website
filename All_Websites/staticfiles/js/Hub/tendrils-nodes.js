import { ANGLE_OFFSET, DRAG_EASE, DRAG_THRESHOLD, HUB_CONFIG, LIMIT_BOUNCE_RATIO, MAX_DRAG_RATIO, } from "./tendrils-config.js";
let activeDrag = null;
...
export function setMaxDragDistances(nodeEls) {
    nodeEls.forEach((node, i) => {
        ...
        if (nodeInitialX === undefined || nodeInitialY === undefined)
            return;
...
//# sourceMappingURL=tendrils-nodes.js.map